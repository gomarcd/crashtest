<template>
    <div class="h-full flex flex-col">
      <div v-if="response" class="p-4 bg-gray-100 border-b flex flex-col gap-2">
      ...
      <div class="flex-grow overflow-auto" v-if="response">
        <!-- Body Tab -->
        <div v-show="activeTab === 'body'" class="h-full font-mono text-sm">
          <pre v-if="formattedResponse" class="p-4 whitespace-pre-wrap">{{ formattedResponse }}</pre>
        ...
        <div v-show="activeTab === 'headers'" class="p-4">
          <table class="w-full text-sm">
            <thead>
              <tr class="text-left">
                <th class="pb-2 font-semibold">Header</th>
                <th class="pb-2 font-semibold">Value</th>
              </tr>
            </thead>
            <tbody>
              <tr v-for="(value, key) in response.headers" :key="key" class="border-t">
